...
exports.uploadFile = async function (
  ...
  var folder;
  if (folderName) {
    folder = await searchFolder(folderName);
    if (!folder) {
...
exports.generateFolderPublicUrl = async function(folderName){
  return await generatePublicUrl(searchFolder(folderName).id);
}